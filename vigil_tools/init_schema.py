...
# Ensure the `core` package is importable. It lives in the cyber_soc_engine
# subtree, not at the STAI 2 root.
project_root = Path(__file__).resolve().parent.parent / "cyber_soc_engine"
